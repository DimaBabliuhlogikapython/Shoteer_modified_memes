...
lose2 = mixer.Sound("pult_yaderka.ogg")
font.init()
text1 = font.Font(None, 80)
text2 = font.Font(None, 60)
win = text1.render("YOU WIN!", True, (0, 255, 0))
win2 = mixer.Sound("URA.ogg")
lose1 = text2.render("ZAVERTIN WIN EZZ", True, (100, 0, 0)) 
mixer.music.load("rugat_zavertina.ogg")
mixer.music.play()



ship = Player(img_hero, 200, win_height-100, 80, 100, 20)
ship2 = Player(img_shampanow, 200, win_height-100, 80, 100, 20)
